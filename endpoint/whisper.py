...
upload_parser.add_argument(
    ...
    location="form",
    required=False,
    help="Nome del modello da utilizzare (tiny, base, large, turbo). Default 'turbo' se non valido o non specificato.",
)
...
class Transcribe(Resource):
    ...
    def post(self):
        ...
        Il parametro 'model_name' e opzionale.
        """
        args = upload_parser.parse_args()
        audio_file = args.get("audio_file")
        model_name = args.get("model_name") or "turbo"
